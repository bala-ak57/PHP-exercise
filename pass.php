...
<body>
<div>
<h1>Enter your mark</h1><br>
<form action="fail.php" method="get">
<table>
    <tr>
        <td><span>Tamil :</span></td>
        <td><input  class="text" name="tamil" value=""></td>
    </tr>
    <tr>
        <td><span>English :</span></td>
        <td><input  class="text" name="english" value=""></td>
    </tr>
    <tr>
        <td><span>maths :</span></td>
        <td><input  class="text" name="maths" value=""></td>
    </tr>
    <tr>
        <td><span>Science :  </span></td>
        <td><input  class="text" name="science" value=""></td>
    </tr>
    <tr>
        <td><span>social :</span></td>
        <td><input  class="text" name="social" value=""></td>
    </tr>
</table>
